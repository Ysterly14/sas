                ...
                children: <Widget>[
                  ...
                  ListTile(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ChangePasswordPage()), // Créez une instance de Page2
                      );
                  ...
                  ListTile(
                    ...
                    leading: const Icon(Icons.admin_panel_settings_outlined, color: Color(0xFFF0E600)),
                    title: const Text('Paramètres Administrateurs', style: TextStyle(color: Colors.white) ,),
                  ),
                  const Divider(
                    color: Color(0xFFF0E600),
                    thickness: 3,
